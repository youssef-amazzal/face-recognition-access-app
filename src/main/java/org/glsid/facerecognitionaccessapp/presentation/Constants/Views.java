...
public class Views {
    ...
    static public String ROOMS_VIEW         = views + "rooms_view.fxml";
    static public String USERS_VIEW         = views + "users_view.fxml";
    static public String WINDOW_VIEW        = views + "window_view.fxml";
    static public String FACE_CAM_VIEW      = views + "face_cam_view.fxml";
